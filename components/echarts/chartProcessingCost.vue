<template>
	<view class="charts-box">
		<view style="display: block;text-align: center;padding-top: 40px;" v-show="dataList.length == 0">
			<image style="width: 100px;height: 66px;" src="../../static/images/noData.png"></image>
			<view>暂无数据</view>
		</view>
		<qiun-data-charts v-show="dataList.length > 0" type="mix" :opts="opts" :chartData="chartData" />
