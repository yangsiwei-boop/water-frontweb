<template>
	<view>
		<scroll-view scroll-y="true">
			...
			<view class="timeSection" style="padding: 20px 18px 0;box-sizing: border-box;">
				<scroll-view scroll-y="true" :show-scrollbar='false' :style="{height: height - 70 + 'px'}">
						...
						<view class="inspectionItemItem" v-for="(item, index) in inspectionTaskList" :key="item.id"
							...
							<view class="inspectionItemLeft">
								<view class="inspectionPeople inspectionText">
									{{item.planInspUserName}}
								</view>
								<!-- <view class="inspectionClasses inspectionText">
									{{item.inspectionLevel}}
								</view> -->
								<view class="inspectionLevel inspectionText">
									{{item.inspectionLevel}}
								</view>
							...
							<view class="inspectionItemRight" :class="rightColor(index, item)">
								<view class="inspectionPlanName"
									...
									{{item.planName}}_{{item.inspectionEquipmentName}}
								</view>
