			...
			<view class="reportDetail" :style="{height: swiperWidth + 'px'}">
				...
				<view class="container">
					...
					<view class="acceptItem">
						...
						<text class="text">
							{{planUpkeepUserName != 'null' ? planUpkeepUserName : '-'}}
						</text>
					</view>
					<view class="acceptItem">
						<text class="labelName">
					...
					<view class="acceptDetail">
						...
						<view class="inspectionContent" style="margin-top: 15px;" v-show="acceptanceStatus == '90' && type =='accept'">
							<textarea class="contentTextarea" placeholder-style="color:#aaa" placeholder="请填写验收意见" />
						</view>
					</view>
					
				</view>
				<view class="footer" v-show="acceptanceStatus == '90' && type == 'accept'  && (isEquipmentManager || isAdmin)">
...
<script>
	...
	export default {
		...
		onLoad(options) {
			...
			this.acceptanceStatus = options.acceptanceStatus
