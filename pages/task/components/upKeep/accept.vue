			...
			<view class="reportDetail" :style="{height: swiperWidth + 'px'}">
				...
				<view class="container">
					...
					<view class="acceptDetail">
						...
						<view class="inspectionContent" style="margin-top: 15px;" v-show="acceptanceStatus == '90'">
...
<script>
	...
	export default {
		...
		onLoad(options) {
			...
			this.formData.upkeepDesc = decodeURIComponent(options.upkeepDesc)
			this.formData.lube = decodeURIComponent(options.lube)
			this.formData.sealingElement = decodeURIComponent(options.sealingElement)
